...
class UserOperationsHolderTest : FunSpec({
    ...
    test("UserOperationsHolder should initialize with provided user operations") {
        ...
        userOperationsHolder.changeName::class.shouldBe(ChangeStringField::class)
        userOperationsHolder.changeSurname::class.shouldBe(ChangeStringField::class)
        userOperationsHolder.changeEmail::class.shouldBe(ChangeStringField::class)
        userOperationsHolder.changePhoneNumber::class.shouldBe(ChangeStringField::class)
        userOperationsHolder.changeVKLink::class.shouldBe(ChangeStringField::class)
