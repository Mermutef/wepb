...
class PostsOperationsHolderTest : FunSpec({
    ...
    val postOperationsHolder = PostsOperationsHolder(postOperations, hashtagOperations, userOperations, mediaOperations)
    ...
    test("PostOperationsHolder should initialize with provided user operations") {
        ...
        postOperationsHolder.fetchPostsByHashtagId::class.shouldBe(FetchPostByIdHashtag::class)
        postOperationsHolder.fetchNNewPosts::class.shouldBe(FetchNNewPosts::class)
        ...
        postOperationsHolder.createPost::class.shouldBe(CreatePosts::class)
